...
public static class ZbroyaDocumentTemplate
{
    ...
    public static ParsedTestDocument Create()
    {
        var document = new ParsedTestDocument
        {
            ...
            Instruction =
                "Прочитайте уважно кожне з наведених нижче речень і оберіть відповідну оцінку залежно від того, " +
                "ЯК ВИ ПОЧУВАЄТЕСЯ ЦІЄЇ МИТІ. Над запитаннями довго не замислюйтеся, правильних чи неправильних відповідей немає. " +
